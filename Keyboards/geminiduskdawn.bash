...
DefaultMap="geminiduskdawn/release.1 stdFuncMap"
...
PartialMaps[1]="geminiduskdawn/release.1.layer.1 stdFuncMap"
PartialMaps[2]="geminiduskdawn/release.1.layer.2 stdFuncMap"
