...
// osDelay is equivalent to delay_cycles
#define osDelay delay_cycles
...
{
    // XXX - This is set to 0 for nRF52
    uint32_t apsel = 0;
    if (!apsel)
...
uint8_t swd_init_debug(void)
{
    ...
    do {
        ...
        // initing the debug
        // XXX nRF52 doesn't use g_target_family->target_before_init_debug
        ...
        // XXX nRF52 doesn't use g_target_family->target_unlock_sequence
